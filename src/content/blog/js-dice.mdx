...
<Latex formula="P (54 \cap 54) = P(54) \times P(54) = P(54)^2"/>

The probability of any roll being less than or equal to 54 is 50%.

<Latex formula="P(54 \cap 54) = 0.5 \times 0.5 = 0.5^2 = 0.25"/>
...
<Latex formula="P(stayAlive) = P(roll)^n"/>
...
<Latex formula="P(54 \cup 54) = P(54) + P(54) - P(54 \cap 54)"/>

P(54) is still equal to 0.5 and the intersection of two P(54) events is 0.25, as
shown above.

<Latex formula="P(54 \cup 54) = 0.5 + 0.5 - 0.25 = 0.75"/>
...
<Latex formula="P(A \cup A \cup A) = P(A \cup (P(A \cup A)))"/>
...
<Latex formula="P(stayAlive) = P(P(54 \cap 54) \cup P(54 \cap 54))"/>

<Latex formula="P(stayAlive) = P(P(54)^2 \cup P(54)^2)"/>

<Latex formula="P(stayAlive) = P(0.5^2 \cup 0.5^2) = P(0.25 \cup 0.25)"/>

<Latex formula="P(stayAlive) = 0.25 + 0.25 - 0.25^2 = 0.4375"/>
...
<Latex formula="f(n) = f(1) \cup f(n-1)"/>
